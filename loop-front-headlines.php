...
<ul>
    ...
    ?>
        <li class="fp-headlines-item">
            <a href="<?php the_permalink(); ?>" class="fp-headlines-item__link" title="<?php printf(esc_attr__('More about %s', 'brhg2016'), the_title_attribute('echo=0')); ?>" rel="bookmark">
                <?php
